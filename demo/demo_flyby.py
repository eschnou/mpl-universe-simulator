...
def main():
    ...
    # Setup grid and point source (same settings as radial demo)
    grid_size = 150
    ...
    impact_param = 15  # Distance above center (inside gravity well)
    ...
    ax.plot([10, 140], [cy + impact_param, cy + impact_param], 'w--',
